...
if(isset($_POST['submit']))
  {
    ...
    $exfacilities=$_POST['exfacilities'];
...
$roompic=md5($pgpic).$extension;
    ...
    $query=mysqli_query($con, "insert into tblpg(OwnerID,StateName, CityName, PGTitle, Type, RPmonth,norooms,Address,Electricity,Parking,Refregerator,Furnished,AC,Balcony,StudyTable,Laundry,Security,exfacilities,MealsBreakfast,MealLunch,MealDinner,Image) value('$ownerid','$statename','$cityname','$pgname','$typepg','$rpmonth','$norooms','$address','$electricity','$parking','$ref','$furnished','$ac','$balcony','$table','$laundry','$security','$exfacilities','$breakfast','$lunch','$dinner','$roompic')");
    if ($query) {
...
<!DOCTYPE html>
<head>
<title>FindYourPG ||PG Form </title>
	...
	<div class="form-w3layouts">
        ...
        <section class="panel">
            <header class="panel-heading">
                List Your PG. <br>
                <h6 style="color: red;">*All the Facilities mention below should be available at your place<br></h6>
            </header>
...
Both
              ...
              <option value="<?php echo $row['StateName'];?>"><?php echo $row['StateName'];?></option>
                  <?php } ?> 
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label">Extra Facilities</label>
                        <div class="col-sm-6">
                            <input class="form-control" id="exfacilities" name="exfacilities" type="text" required="true" value="">
                        </div>
                    </div>
                    <div class="form-group has-success">
